...
| 📦 收纳 | 桌面 / 下载 / 主目录顶层散落的东西按类型一键归位（可撤销，散落太多每天提醒一次，可选「下载完问我要不要归位」）；认不出的亮出内容自己挑去处；结构一览图；「刚建的在哪」；拖个项目进来让 AI 讲它是什么、怎么跑、从哪读起，能接着问、一站一站「带我读」、「考考我」五道题、「学习顺序」一键变任务、「帮我写 README」；贴个 GitHub 地址直接拉下来看懂；下载了两遍的一键清 | — |
