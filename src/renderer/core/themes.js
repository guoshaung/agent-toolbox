...
export const THEMES = [
  ...
  // ---- 游戏味 ----
  make({ id:'cyberpunk', name:'赛博朋克', desc:'夜之城：黑底、荧光黄与青，锐利', bg:'#111014', raised:'#19171d', sunken:'#0b0a0d', panel:'#201d25', line:'#3a3521', text:'#f3efd9', dim:'#c2bc9c', faint:'#807a5c', a:'#fcee0a', b:'#00f0ff', c:'#ff2a6d', good:'#4ade80', warn:'#fcee0a', bad:'#ff2a6d', glow:.12 }),
  make({ id:'miku', name:'初音', desc:'深灰底、青绿与樱粉，舞台灯', bg:'#12181a', raised:'#18222a', sunken:'#0c1214', panel:'#1d2a30', line:'#274148', text:'#dff5f2', dim:'#a2c9c4', faint:'#6d8f8b', a:'#39c5bb', b:'#ff9ec6', c:'#e7f5a5', good:'#5ee0a0', warn:'#f0c95f', bad:'#ff6f91', glow:.14 }),
  make({ id:'sakuranight', name:'夜樱', desc:'墨色底、樱粉与金，晚上的樱花', bg:'#171217', raised:'#211923', sunken:'#100c11', panel:'#2a2030', line:'#43304a', text:'#f3e6ee', dim:'#c8adc0', faint:'#88718a', a:'#ff8fb1', b:'#ffd166', c:'#c084fc', glow:.14 }),
  // ---- 浅色 ----
