 ...
 */
export const TOOLS = [ask, docs, typing, focus, study, notebook, notes, tidy, api, git, netlog, monologue, eat, container, dsh, tavern, voicebox, digitalHuman, avatarRig, pet, history, video, research, coach, terms, dock, skills, remote, controls, appearance, voice, gesture, tasks, settings];
