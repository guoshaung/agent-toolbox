...
contextBridge.exposeInMainWorld('toolbox', {
  ...
  agentRun: {
    ...
    /** 本机装了哪些 AI 桌面客户端：{ codex: 'ChatGPT', ... } */
    desktopApps: () => ipcRenderer.invoke('agent:desktopApps'),
  ...
  gestureWin: {
    ...
    paths: () => ipcRenderer.invoke('gesture:paths'),
  ...
  tidy: {
    ...
    weekly: (on) => ipcRenderer.invoke('tidy:weekly', on),
    ...
    clone: (url) => ipcRenderer.invoke('tidy:clone', url),
